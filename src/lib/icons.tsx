...
export const CopyAcrossIcon = (props: CopyAcrossIconProps) => {
  ...
  return (
    <Icon {...otherProps}>
      ...
      <path clipPath={`url(#${id})`} d="M19 3h-4.2c-.4-1.2-1.5-2-2.8-2s-2.4.8-2.8 2H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zm-7 0a1 1 0 0 1 0 2c-.6 0-1-.4-1-1s.4-1 1-1z" />
    </Icon>
  );
};
